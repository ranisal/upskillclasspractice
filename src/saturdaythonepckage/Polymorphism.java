...
public class Polymorphism {
	...
	public static void main(String[] args) {
		 ...
		 * method overloading.compile time /static polymorphism same method name with different signature to overload
		 * method overriding runtime polymorphism /dynamic binding same method name with parent to override  
		 */
	}
